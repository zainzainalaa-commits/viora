    ...
    <>
      ...
      {isTauri && (
        <Section
          ...
          subtitle={t("Use your operating system's native title bar and window buttons instead of Viora's built-in ones. Handy if the in-app buttons ever feel out of reach, like during playback.")}
        >
          <NativeTitleBarRow />
        </Section>
      )}
    ...
    <div className="flex items-start gap-3 rounded-xl border border-edge-soft bg-canvas/40 px-4 py-3.5">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        ...
        <p className="text-[12.5px] leading-relaxed text-ink-subtle">
          {t("Show your operating system's own title bar with its minimize, maximize, and close buttons. They stay reachable everywhere, including while a video is playing. Turn this off to use Viora's built-in window buttons.")}
        </p>
      </div>
      <FocusButton
        type="button"
